...
const I18N = {
  de: {
    ...
    hist_title: "Verlauf",
    hist_sys_chart: "Systeme pro Fraktion",
    hist_pil_chart: "Piloten pro Miliz",
    hist_now: "jetzt",
    ...
    det_activity: "AKTIVITÄT (1H)",
    det_note: "LAGEBERICHT",
    det_trend_short: "TREND",
    det_links: "LINKS",

    st_critical: "KRITISCH",
    st_contested: "UMKÄMPFT",
    st_stable: "STABIL",

    sec_contested: "Umkämpfte Systeme",
    changes_head: "Systemwechsel · 48h",
    systems_held: "Systeme",
    contested_n: "umkämpft",
    wz_all: "Alle",
    pilots: "Piloten",
    ...
    map_hint: "System anklicken für Details",
    ...
    lp_title: "LP-Store Optimizer",
    lp_footnote: "Marktwert = Jita 4-4 Buy-Order. ISK/LP = (Marktwert − ISK-Kosten) / LP.",
    lp_militia: "Militia-Corporation",
    lp_jita_btn: "Jita-Preise laden",
    lp_jita_reload: "Aktualisieren",
    ...
    lb_name: "Name",
    lb_miliz: "Miliz",
    lb_period_yesterday: "Gestern",
    lb_period_week: "7 Tage",
    lb_period_total: "Gesamt",
    lb_cat_char_kills: "Character Kills",
    lb_cat_char_vp: "Character Victory Points",
    lb_cat_corp_kills: "Corp Kills",
    lb_cat_corp_vp: "Corp Victory Points",

    cmp_title: "Military Campaigns",
    cmp_status_active: "Aktiv",
  ...
  en: {
    ...
    hist_title: "History",
    hist_sys_chart: "Systems per faction",
    hist_pil_chart: "Pilots per militia",
    hist_now: "now",
    ...
    changes_head: "System changes · 48h",
    systems_held: "systems",
    contested_n: "contested",
    wz_all: "All",
    pilots: "Pilots",
    ...
    map_hint: "Click a system for details",
    map_zoom_in: "Zoom in",
    ...
    lp_title: "LP Store Optimizer",
    lp_footnote: "Market value = Jita 4-4 buy order. ISK/LP = (market value − ISK cost) / LP.",
    lp_militia: "Militia corporation",
    lp_jita_btn: "Load Jita prices",
    lp_jita_reload: "Refresh",
    ...
    lb_name: "Name",
    lb_miliz: "Militia",
    lb_period_yesterday: "Yesterday",
    lb_period_week: "7 days",
    lb_period_total: "All time",
    lb_cat_char_kills: "Character kills",
    lb_cat_char_vp: "Character victory points",
    lb_cat_corp_kills: "Corp kills",
    lb_cat_corp_vp: "Corp victory points",
