...
const I18N = {
  de: {
    ...
    map_hint: "Kreis = System (Farbe: Besatzer, weißer Ring: umkämpft, roter Ring: verwundbar, Leuchten: Kills der letzten Stunde). Linien = Stargates. Mausrad = Zoom, Ziehen = Verschieben, Doppelklick = Reset — reingezoomt erscheinen die vollen Systemnamen.",
  ...
  en: {
    ...
    map_hint: "Circle = system (color: occupier, white ring: contested, red ring: vulnerable, glow: kills last hour). Lines = stargates. Wheel = zoom, drag = pan, double click = reset — zooming in reveals full system names.",
    map_zoom_in: "Zoom in",
