...
## Deferred: Corp directory (community-maintained)
...
- **Per-item LP crash warnings** — the militia-level LP history shipped;
  per-item price trend tracking would be the next step.
...
- **EVE SSO / personal stats** — would require rebuilding the site around
  authentication; decided against
